...
export const JobsPanel: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-semibold text-cyan-400">Jobs Management</h2>
        <p className="text-gray-400">Track and manage field operations</p>
      </div>
      ...
      {activeTab === 'jobs' ? (
        <div className="space-y-6">
          ...
          {/* Jobs List */}
          <JobsList searchQuery={searchQuery} selectedFilters={selectedFilters} />
        </div>
      ) : (
        <JobsOverview />
      )}
